...
namespace Yunu.Commerce.Availability.Infrastructure;

/// <summary>
/// Composition entry point for the Availability Infrastructure layer (docs §49).
...
/// </summary>
public static class AvailabilityInfrastructureServiceCollectionExtensions
{
