...
namespace Yunu.Commerce.Fulfillment.Infrastructure;

/// <summary>
/// Composition entry point for the Fulfillment Infrastructure layer (docs §49).
...
/// </summary>
public static class FulfillmentInfrastructureServiceCollectionExtensions
{
