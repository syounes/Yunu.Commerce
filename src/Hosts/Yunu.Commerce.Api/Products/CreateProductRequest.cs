...
/// GoogleCategoryId is required and is the only Google taxonomy input
/// accepted from callers; the canonical path is always resolved server-side
/// from SQL Server and must never be supplied by the caller.
/// </summary>
